...
<section class="BottomForm Topform bg-white">
	<div class="container">
		<div class="top-form-shadow">
			<form>
				...
				<div class="row align-items-center justify-content-center">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 sm-mb-2">
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 sm-mb-2">
						<select multiple  id="langOpt21" class="mb-0 full form-control top-form">
						...
						?>	
								<option <?php if (in_array($parent_product_cat->slug, $my_c)){ echo 'selected="selected"'; } ?> value="<?php echo $parent_product_cat->slug; ?>" > <?php echo $parent_product_cat->name; ?></option>
						<?php	
								}
							}
						?>
					...
					<div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12 sm-mb-2">
						<button type="button" class="uppercase btn btn-orange mb-0 btn-block btn-map">Find Camps</button>
...
$(document).on("click",".cancelbtn",function() {
	...
	if(t == 'location'){
		...
		const params = { q: f_ar,l: $("#l").val(),f: $("#f").val(),lat: $("#lat").val(),lng: $("#lng").val() }
		const paramString = new URLSearchParams(params)
		var url = 'https://shop.australiansportscamps.com.au/location/?'+paramString.toString();
		window.location.href = url;
	}
