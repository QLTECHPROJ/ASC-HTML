                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xl-7 col-lg-7 col-md-7 mb-0">
                                                            <div class="form-group mb-20">
                                                                ...
                                                                <span class="font-15 color-70 font-regular mb-3 kidinfrmtitletxt"><br></span>
                                                                <div class="row">
                                                        ...
                                                        <div class="col-xl-5 col-lg-5 col-md-5 mb-0">
                                                            <div class="form-group mb-20">
                                                                ...
                                                                <span class="font-15 color-70 font-regular mb-3 kidinfrmtitletxt">(For camp planning purposes)</span>
                                                                <div class="d-block">
	                                                                <label class="radiocustom blue-border mb-2 mr-2">Girl
																	  <input type="radio" checked="checked" name="radio">
																	  <span class="checkmark"></span>
																	</label>
																	<label class="radiocustom blue-border mb-2 mr-2">Boy
																	  <input type="radio" checked="checked" name="radio">
																	  <span class="checkmark"></span>
																	</label>
								                                </div>
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-0">
                                                            <div class="form-group mb-20">
                                                                ...
                                                                <span class="font-15 color-70 font-regular mb-3 kidinfrmtitletxt">Current school grade or year level.</span>
                                                                <select class="mb-1 master form-control">
								                                    <option>Select an option</option>
								                                    <option>2</option>
								                                    <option>3</option>
                                                        ...
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mb-0">
                                                            <div class="form-group mb-20">
                                                                ...
                                                                <span class="font-15 color-70 font-regular mb-3 kidinfrmtitletxt">What club or team do you play for? If you only play for a school team, enter your school and team
name/nickname.</span>
                                                                <input type="text" class="mb-1 master form-control"
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-0">
                                                            <div class="form-group mb-20">
                                                                ...
                                                                <span class="font-15 color-70 font-regular mb-3 kidinfrmtitletxt">(General guide for camp grouping purposes)</span>
                                                                <select class="mb-1 master form-control">
								                                    <option>Select an option</option>
                                                        ...
                                                        <div class="col-xl-6 col-lg-6 col-md-6 mb-0">
                                                            <div class="form-group mb-20">
                                                                ...
                                                                <span class="font-15 color-70 font-regular mb-3 kidinfrmtitletxt">(For camp grouping purposes)</span>
                                                                <input type="text" class="mb-1 master form-control"
                                                                    placeholder="Enter School">
                                                            </div>
                                                        </div>
                                                        <div class="col-xl-12 col-lg-12 col-md-12 mb-0">
                                                            <div class="form-group mb-20">
															    <label class="master-label">Message*</label>
