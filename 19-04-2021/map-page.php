...
#map_canvas .card-title{   line-height: 25px !important; font-size: 14px !important; font-weight: 700; color: #3B3B3B; margin-bottom: 0px !important; margin-top: 10px; }
p.card-text { line-height: 25px !important; font-size: 14px !important; margin-bottom: 6px !important; color: #707070}
.main-price {color: #2A74B6; margin-bottom: 10px; font-size: 16px;font-weight: 700 !important;}
...
function initialize() {
	...
	data.forEach(function(mapData,idx) {
		if(mapData.lat != null){
			...
			var contentHtml = "<div style='overflow:hidden;'><div class='row'><div class='col-md-12 col-lg-12 col-xl-12'>"+mapData.Img+"<h5 class='card-title'>"+mapData.Name+"</h5><p class='card-text'>"+mapData.Dates+"</p><p class='card-text'>"+mapData.Venue+"</p><p class='nav-link p-0 main-price font-bold'>$"+mapData.Price+"</p><p class='card-text'><a href='"+mapData.URL+"' class='btn btn-orange' >Book Now</a></p></div></div></div>";
